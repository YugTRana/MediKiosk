    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden border border-slate-100">
        <div className="bg-slate-900 p-8 text-center relative overflow-hidden">
          ...
          <ShieldAlert className="w-12 h-12 text-purple-400 mx-auto mb-4 relative z-10" />
          <h1 className="text-2xl font-bold text-white relative z-10">Admin Portal Access</h1>
          <p className="text-slate-400 mt-2 text-sm relative z-10">Secure login for system administrators</p>
        </div>
